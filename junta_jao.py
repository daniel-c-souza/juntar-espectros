...
# -------------------------------
output_csv = os.path.join(CSV_DIR, f"{exp_name}_consolidado_jao.txt")
df_combined.T.iloc[1:].to_csv(output_csv, index=False, sep="\t", decimal=".",header=False)
...
plt.tight_layout()
output_fig = os.path.join(PLOT_DIR, f"{exp_name}_espectros_jao.png")
